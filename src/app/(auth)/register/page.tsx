  ...
  return (
    <div className="rounded-xl border border-gray-200 bg-white p-8 shadow-sm">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          <label htmlFor="name" className="block text-sm font-medium text-gray-700">{l.name}</label>
        ...
        <div>
          <label htmlFor="password" className="block text-sm font-medium text-gray-700">{l.password}</label>
      ...
      <p className="mt-4 text-center text-xs text-gray-400">
        {l.privacyAgreement}{" "}
        <Link href="/privacy" className="underline hover:text-gray-600">{l.privacyPolicy}</Link>.
      </p>
